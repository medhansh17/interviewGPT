        ...
        <div className="border rounded shadow-sm p-4 mt-4 mx-[1rem] md:w-[60%]">
            <div className="cursor-pointer">
                ...
                <div className="flex md:flex-wrap lg:flex-nowrap items-center gap-3">
                    ...
                    >
                        <img width="25" height="25" src={selectedOption === "Correct" ? "https://img.icons8.com/color/48/checkmark--v1.png" : "https://img.icons8.com/material-sharp/24/checkmark--v1.png"} alt="checkmark--v1" />
                    </button>
                    ...
                    >
                        <img width="25" height="25" src={selectedOption === "PartiallyCorrect" ? "https://img.icons8.com/color/48/inspection.png" : "https://img.icons8.com/fluency-systems-regular/48/inspection.png"} alt="inspection" />
                    </button>
                    ...
                    >
                        <img width="25" height="25" src={selectedOption === "Incorrect" ? "https://img.icons8.com/external-others-agus-raharjo/64/external-incorrect-flat-website-ui-others-agus-raharjo.png" : "https://img.icons8.com/external-filled-agus-raharjo/64/external-incorrect-glyph-website-ui-filled-agus-raharjo.png"} alt="external-incorrect" />
                    </button>
                </div>
            </div>
            ...
            <div className="mb-3 md:mx-[2rem] shadow-lg">
                ...
                <TETabsContent>
                    ...
                    <TETabsPane show={basicActive === "tab2"}>
                        ...
                        <TETabsContent>
                            {techSkill?.technical_skills?.technical_skills?.map((item: { name: string, questions: any }, index: number) => (
                                // <TechAccordion
                                //     key={index}
                                //     title={item?.name}
                                //     techSkill={techSkill}
                            ...
                            <TETabsPane show={nestedActive === "nestedTab2"}>Nested Tab 2 content</TETabsPane>
                        </TETabsContent>
                    </TETabsPane>
