	...
	return (
		<section className="pricing mt-16 w-full" >
			...
			>
				...
				<div className="container py-5 px-0 form-style">
					...
					<div className="w-100 mx-auto">
						<form className="needs-validation" action="https://getform.io/f/lbjnkgzb" name="popupcontact" method="POST">
							<div className="row mx-1.5">
								<div className="col-12 col-md-4 mb-3 px-1.5">
									<label>
										Full Name
										<span>*</span>
									</label>
							...
							<div className="form-row mx-1.5">
								<div className="col-12 col-md-12 mb-3 px-1.5">
									<label>Subject</label>
									<select style={custom} >
								...
								<div>
									...
									<textarea name="description" required rows={5} className="form-control text-field-bg" style={{
