...
const McqComp = () => {
  return (
    <div className="max-w-lg mx-auto p-4">
            ...
            <p className="mb-4">Which of the following acronyms represents the process by which undefined from multiple source systems is consolidated into a single undefined warehouse?</p>
            <form>
