...
const UserReducer = (state: UserState, action: UserAction): UserState => {
  switch (action.type) {
    case 'SET_JOB_LIST':
      ...
      case 'ADD_CANDIDATE':
      return { ...state, candidate_list: [...state.candidate_list, action.payload] }; 
      case 'DELETE_CANDIDATE':
      return {
        ...state,
        candidate_list: state.candidate_list.filter(candidate => candidate.candidate_name !== action.payload),
      }; 
