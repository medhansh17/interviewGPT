      ...
      <div className="max-w-md w-full p-6 bg-white dark:bg-zinc-700 rounded-lg shadow-md">
        ...
        <form className="mb-4" onSubmit={handleSubmit}>
          <input
            ...
            className="w-full p-2 border border-zinc-300 dark:border-zinc-600 rounded-md focus:outline-none focus:ring focus:ring-blue-400 dark:focus:ring-blue-600 dark:bg-zinc-600"
          />
          <button
            type="submit"
