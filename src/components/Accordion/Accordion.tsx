			...
			>
				...
				>
					<AiOutlineCheckCircle
						title="Correct"
						className={`accordion-buttonsContainer-button accordion-buttonsContainer-button-green ${selectedOption === "c" &&
					...
					<MdGppMaybe
						...
						className={`accordion-buttonsContainer-button accordion-buttonsContainer-button-orange ${selectedOption === "pc" &&
					...
					<AiOutlineCloseCircle
						title="Wrong"
						className={`accordion-buttonsContainer-button accordion-buttonsContainer-button-red ${selectedOption === "w" &&
					...
					<BsSkipForward
						title="Skip"
						className={`accordion-buttonsContainer-button accordion-buttonsContainer-button-gray ${selectedOption === "sk" &&
